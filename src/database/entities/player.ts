...
export class Player {
    ...
    Sport!: Sport;
    @ManyToOne(() => Image, image => image.players) // Ensure this relationship is defined correctly in the Image entity
    Image!: Image;


    constructor(id?: number, name?: string,lastname?: string,birth_date?: Date,formationCenter?: FormationCenter, 
        sport?: Sport,image?:Image) {
        if (id) this.Id = id;
